...
class ArtistAdmin(admin.ModelAdmin):
    list_display = ('name', 'gid', 'tracked', 'number_songs', 'added_at', 'last_synced_at')
...
class SongAdmin(admin.ModelAdmin):
    list_display = ('name', 'gid', 'primary_artist', 'downloaded', 'unavailable', 'failed_count', 'created_at')
...
class AlbumAdmin(admin.ModelAdmin):
    list_display = ('name', 'artist', 'album_type', 'album_group', 'downloaded', 'wanted', 'total_tracks', 'failed_count')
...
class TaskHistoryAdmin(admin.ModelAdmin):
    list_display = ('task_id', 'type', 'entity_type', 'entity_id', 'status', 'progress_percentage', 'started_at', 'completed_at')
    ...
    fieldsets = (
        ...
        ('Timing', {
            'fields': ('started_at', 'completed_at', 'duration_seconds', 'timeout_minutes', 'last_heartbeat')
        }),
        ('Progress', {
