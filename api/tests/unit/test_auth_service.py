...
class TestAuthService:
    ...
    def test_verify_password_success(self, auth_service):
        ...
        result = auth_service.verify_password('admin', auth_service.users['admin'].hashed_password)
        assert result is True
    
    def test_verify_password_failure(self, auth_service):
        """Test failed password verification."""
        result = auth_service.verify_password('wrong_password', auth_service.users['admin'].hashed_password)
