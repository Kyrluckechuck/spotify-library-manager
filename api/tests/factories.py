...
from library_manager.models import Artist, Album, Song, TrackedPlaylist, TaskHistory, DownloadHistory
...
class TaskHistoryFactory(DjangoModelFactory):
    ...
    status = Faker('random_element', elements=['RUNNING', 'COMPLETED', 'FAILED', 'PENDING'])
