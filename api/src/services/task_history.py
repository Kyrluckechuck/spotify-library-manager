...
from ..types.models import TaskHistory, TaskStatus, TaskType, EntityType
...
class TaskHistoryService(BaseService[TaskHistory]):
    ...
    async def get_connection(
        ...
        if entity_type:
            ...
            queryset = queryset.filter(entity_type=entity_mapping.get(entity_type, entity_type.value))
    ...
    async def create_task(self, task_id: str, task_type: TaskType, entity_id: str, entity_type: EntityType) -> DjangoTaskHistory:
