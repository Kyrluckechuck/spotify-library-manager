    ...
    <div className="mb-6">
      ...
      <div className="flex gap-4">
        <button 
          ...
          style={{ 
            backgroundColor: currentEnabledFilter === 'all' ? '#3730a3' : 'white',
        ...
        <button 
          ...
          style={{ 
            backgroundColor: currentEnabledFilter === 'enabled' ? '#15803d' : 'white',
        ...
        <button 
          ...
          style={{ 
            backgroundColor: currentEnabledFilter === 'disabled' ? '#374151' : 'white',
