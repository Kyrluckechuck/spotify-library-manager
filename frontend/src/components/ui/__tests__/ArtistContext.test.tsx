...
describe('ArtistContext', () => {
  ...
  it('has correct styling classes', () => {
    ...
    const container = screen.getByText('Test Artist').closest('div')?.parentElement?.parentElement
    expect(container).toHaveClass('bg-gradient-to-r', 'from-indigo-50', 'to-purple-50', 'border', 'border-indigo-200', 'rounded-lg', 'p-4', 'mb-6')
  })
  ...
  it('displays artist name with correct styling', () => {
    ...
    expect(artistName).toHaveClass('text-lg', 'font-semibold', 'text-indigo-900')
  })
