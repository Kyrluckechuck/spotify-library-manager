...
export function AlbumFilters({ 
  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <div>
        <h3 className="text-sm font-medium text-gray-700 mb-2">Wanted Status</h3>
        <div className="flex gap-4">
          <button 
            ...
            style={{ 
              backgroundColor: currentWantedFilter === 'all' ? '#3730a3' : 'white',
          ...
          <button 
            ...
            style={{ 
              backgroundColor: currentWantedFilter === 'wanted' ? '#15803d' : 'white',
          ...
          <button 
            ...
            style={{ 
              backgroundColor: currentWantedFilter === 'unwanted' ? '#c2410c' : 'white',
      ...
      <div>
        <h3 className="text-sm font-medium text-gray-700 mb-2">Download Status</h3>
        <div className="flex gap-4">
          <button 
            ...
            style={{ 
              backgroundColor: currentDownloadFilter === 'all' ? '#3730a3' : 'white',
          ...
          <button 
            ...
            style={{ 
              backgroundColor: currentDownloadFilter === 'downloaded' ? '#15803d' : 'white',
          ...
          <button 
            ...
            style={{ 
              backgroundColor: currentDownloadFilter === 'pending' ? '#a16207' : 'white',
