interface SongFiltersProps {
  ...
  onDownloadFilterChange: (filter: 'all' | 'downloaded' | 'pending' | 'unavailable') => void;
}
    ...
    <div className="mb-6">
      ...
      <div className="flex gap-4">
        ...
        <button 
          ...
          style={{ 
            backgroundColor: currentDownloadFilter === 'unavailable' ? '#dc2626' : 'white',
            color: currentDownloadFilter === 'unavailable' ? 'white' : '#374151'
          }}
        >
          Unavailable
        </button>
