...
export type GetArtistQuery = { artist?: { id: number, name: string, gid: string, isTracked: boolean, addedAt?: string | null, lastSynced?: string | null } | null };
...
export type GetArtistsQuery = { artists: { totalCount: number, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges: Array<{ id: number, name: string, gid: string, isTracked: boolean, addedAt?: string | null, lastSynced?: string | null }> } };
...
export type SyncArtistMutation = { syncArtist: { id: number, name: string, gid: string, isTracked: boolean, addedAt?: string | null, lastSynced?: string | null } };
...
export type DownloadUrlMutation = { downloadUrl: { success: boolean, message: string, artist?: { id: number, name: string, gid: string, isTracked: boolean, addedAt?: string | null, lastSynced?: string | null } | null, album?: { id: number, name: string, spotifyGid: string, totalTracks: number, wanted: boolean, downloaded: boolean, albumType?: string | null, albumGroup?: string | null, artist?: string | null, artistId?: number | null } | null, playlist?: { id: number, name: string, url: string, enabled: boolean, autoTrackArtists: boolean, lastSyncedAt?: string | null } | null } };
...
export type CreatePlaylistMutation = { createPlaylist: { id: number, name: string, url: string, enabled: boolean, autoTrackArtists: boolean, lastSyncedAt?: string | null } };
...
export type GetSongsQuery = { songs: { totalCount: number, edges: Array<{ id: number, name: string, gid: string, primaryArtist: string, primaryArtistId: number, createdAt: string, failedCount: number, bitrate: number, unavailable: boolean, filePath?: string | null, downloaded: boolean, spotifyUri: string }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } };
...
export type GetSongQuery = { song?: { id: number, name: string, gid: string, primaryArtist: string, primaryArtistId: number, createdAt: string, failedCount: number, bitrate: number, unavailable: boolean, filePath?: string | null, downloaded: boolean, spotifyUri: string } | null };
...
export type GetTaskHistoryQuery = { taskHistory: { totalCount: number, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges: Array<{ cursor: string, node: { id: string, taskId: string, type: TaskType, entityId: string, entityType: EntityType, status: TaskStatus, startedAt: string, completedAt?: string | null, durationSeconds?: number | null, progressPercentage?: number | null, logMessages: Array<string> } }> } };
